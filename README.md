...
This package has been tested with Unity versions 2017.1.5f1+, however to use the Android autogenerated App.java/AndroidManifest.xml [feature](#android-setup) you must using version 2018.2.0+, prior to this version .java files were not treated as source files for Android plugins, see [release notes](https://unity3d.com/unity/whats-new/unity-2018.2.0).
